...
| `LYS.Refiner_版本号_x64-standalone.exe` | 免安装，双击即用 |
...
| 输入 | 输出 | 原因 |
| --- | --- | --- |
| `spo + ti + fy` | `spotify` | 短词，速度均匀 |
| `a + lone` | `alone` | 单字母前缀保护 |
| `dra + ma,` | `drama,` | 短词，视觉宽度足够 |
| `moon + light` | `moon / light` | 长拖音，后半明显拖长 |
| `mid + night` | `mid / night` | 同上 |
| `There + ov + er,` | `There / over,` | 长词惩罚 |
| `twen + ty-` | `twenty-` | 连字符在词内，允许合 |
| `twenty- + two` | `twenty- / two` | 连字符在边界，不合 |
