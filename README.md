...
| `LYS-Refiner-Legacy-win_x64.exe` | Legacy 兼容版（见下方说明） |

### Legacy 版本

适用于无法运行 Tauri 版本的旧系统（如 Windows 7/8/8.1 或早期 Windows 10）。

- 基于 Neutralino.js，单文件运行
- 需要系统已安装 Chrome 或 Firefox
- 功能与主版本一致，但窗口体验不如 Tauri 版
- 有条件运行 Tauri 版时不推荐使用
